                    ...
                    <table className="w-full text-left border border-collapse sm:border-separate border-dark rounded-2xl text-dark" >
                        <tbody>
                            <tr>
                                ...
                                <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-dark text-slate-700 bg-slate-100">Image</th>
                                <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-dark text-slate-700 bg-slate-100">Title</th>
                                <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-dark text-slate-700 bg-slate-100">Price</th>
                                <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-dark text-slate-700 bg-slate-100">Category</th>
                                <th scope="col" className="h-12 px-6 text-md font-bold fontPara border-l first:border-l-0 border-dark text-slate-700 bg-slate-100">Date</th>
                            ...
                            {getAllProduct.map((item, index) => {
                                const { id, title, price, category, date, productImgUrl } = item
                                return <tr key={index} className="text-dark">
                ...
                <div className="flex justify-center">
                    <svg className="text-dark animate-spin" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path
                            ...
                            stroke="currentColor" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" className="text-plane">
                        </path>
                    </svg>
                </div>
