...
const products = [
    {
        ...
        size: '8 UK',
        imageSrc:
            '/src/assets/items/5-1-300x300.webp',
    },
    {
        id: 2,
        ...
        size: '8 UK',
        imageSrc:
            '/src/assets/items/Gluten-Free-Chaat-Masala-4-300x300.webp',
    },
    {
        id: 3,
        ...
        color: 'Black',
        imageSrc:
            '/src/assets/items/SBC_1553.webp',
    },
]
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 mb-6">
                                    <button
                                        className="w-full px-4 py-3 text-center text-gray-100 bg-dark border border-transparent dark:border-gray-700 hover:border-dark hover:text-primary hover:bg-light rounded-xl font-bold"
                                    >
                                        CHECKOUT
                                    </button>
                                </div>
