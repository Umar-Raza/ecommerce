                            ...
                            <div className="">
                                <div className="">
                                    <img
                                        ...
                                        src="/src/assets/items/Gluten-Free-Chaat-Masala-4-300x300.webp"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div className="w-full px-4 md:w-1/2">
                            <div className="lg:pl-20">
                                            ...
                                            <li>
                                                <a href="">
                                                    <svg
                                                        ...
                                                        height={16}
                                                        fill="currentColor"
                                                        className="w-4 mr-1 text-dark dark:text-gray-400 bi bi-star "
                                                        viewBox="0 0 16 16"
                                                    >
                                ...
                                <div className="flex flex-wrap items-center mb-6">
                                    ...
                                    <button
                                        className="w-full px-4 py-3 text-center text-dark bg-light border border-primary  hover:bg-dark hover:text-gray-100 rounded-xl font-bold"
                                    >
                                        ADD TO CART
                                    </button>
                                </div>
